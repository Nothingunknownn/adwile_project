...
class AccountTests(APITestCase):
    ...
    def _list_teasers(self, user: User, home: bool = False):
        ...
        return self.client.get(reverse("teaser-home" if home else "teaser-list"))
    ...
    # Тест получения списка тизеров пользователем с домашней страницы(тизеров нет)
    ...
    # Тест получения списка тизеров админом с домашней страницы(тизеров нет)
    ...
    # Тест получения списка тизеров админом с домашней страницы(тизеры есть)
