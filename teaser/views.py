...
class TeaserViewSet(ModelViewSet):
    ...
    # Доступ только для авторизованных пользователей + Админ/Создатель
    permission_classes = [IsAuthenticated, IsOwnerOrAdmin]
    queryset = Teaser.objects.all()

    def list(self, request, *args, **kwargs):
        """Отдает список тизеров, в случае если пользователь не админ, перенаправляет на эндпоинт '/home'"""
    ...
    def get_serializer_class(self):
        """Возвращает пользовательские сериализаторы на основе действий и ролей."""
